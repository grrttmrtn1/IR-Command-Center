...
import {
  ...
  ShieldCheck, Mail, BookMarked, PhoneCall, TrendingUp, ScrollText, Code2,
} from "lucide-react";
import { NotificationBell } from "@/components/NotificationBell";
import { GlobalSearch } from "@/components/GlobalSearch";

type NavItem = { href: string; label: string; icon: React.ElementType; minRole: string };
...
const navSections: NavSection[] = [
  ...
  },
  {
    label: "Preparedness",
    items: [
      { href: "/readiness", label: "Readiness Score", icon: TrendingUp, minRole: "OBSERVER" },
      { href: "/playbooks", label: "Playbooks", icon: BookMarked, minRole: "OBSERVER" },
      { href: "/ir-plan", label: "IR Plan", icon: ScrollText, minRole: "OBSERVER" },
      { href: "/contacts", label: "Contact Directory", icon: PhoneCall, minRole: "OBSERVER" },
    ],
  },
  {
    label: "Response",
...
const adminItems: NavItem[] = [
  ...
  { href: "/api-docs", label: "API Docs", icon: Code2, minRole: "ADMIN" },
];
...
export function Sidebar() {
  ...
  function NavLink({ href, label, icon: Icon, minRole }: NavItem) {
